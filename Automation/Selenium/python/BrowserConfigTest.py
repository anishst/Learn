# https://github.com/qxf2/42Floors/blob/master/DriverFactory.py
# https://github.com/qxf2/42Floors/blob/master/Demo_Test.py
"""
DriverFactory class
...
class DriverFactory():
    ...
    def __init__(self,browser='ie',sauce_flag='N',browser_version=None,platform=None):
...
run_demo_test("chrome","test","test","www.google.com")